...
# # View Joint Errors --------------------------------------------------------
# filename = "/home/amy/whoi_ws/src/min_variance_calibration/min_variance_calibration/results/sweep_joint_errors/joint_results1.csv"
# df = pd.read_csv(filename, delimiter=",")
#
...
# ax[2,1].set_ylabel("Average camera position error (meters)")
# plt.show()
# # plt.show()
# #
...
# Plot total results ----------------------------------------------
filename = "/home/amy/whoi_ws/src/min_variance_calibration/min_variance_calibration/results/sweep_joint_errors/joint_results_all.csv"
df = pd.read_csv(filename, delimiter=",")
