...
# View Joint Errors
filename = "/home/amy/whoi_ws/src/min_variance_calibration/min_variance_calibration/results/sweep_joint_errors/joint_results_base_optimizer_0_180.csv"
df = pd.read_csv(filename, delimiter=",")
...
# plt.xlabel("Angle offset (degrees)")
# ax[0].set_ylabel("Objective function output (tot. distance)")
